...
# AWS ECS Infrastructure Deployment Script (Fixed)
...
echo "🚀 Deploying Perfect PO API ECS Infrastructure (Fixed)..."
...
echo "🏗️  Deploying infrastructure with CloudFormation (Fixed template)..."

if [ "$OPERATION" = "create-stack" ]; then
    aws cloudformation create-stack \
        --stack-name $STACK_NAME \
        --template-body file://ecs-infrastructure-fixed.yaml \
